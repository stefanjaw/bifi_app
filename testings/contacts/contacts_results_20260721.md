...
|---|------|-------------|----------|
| B-01 | 3.2 | **Save button only appears when form is dirty** — On the Create form, the Save button is hidden until at least one field is modified. Users may not realize they need to type something before the Save button appears. Confusing UX for new users. | Medium |
