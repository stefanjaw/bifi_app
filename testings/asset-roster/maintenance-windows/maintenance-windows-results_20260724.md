...
Tested: 2026-07-21 (re-tested 2026-07-22 — all MW-03 through MW-07 fixes verified, re-tested 2026-07-23 with in-app navigation, re-tested 2026-07-24 after MW-02 fix)
Method: Automated UI tests via Playwright browser

> **2026-07-24 re-test scope:** MW-02 (duplicate names silently allowed) — backend `maintenance-window.model.ts` `unique: true` index added. Pending test: requires backend restart and UI verification that creating a maintenance window with a duplicate name is rejected.
