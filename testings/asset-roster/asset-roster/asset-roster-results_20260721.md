...
| # | Test | Expected Result | Pass/Fail |
|---|------|----------------|-----------|
| 15.1 | Verify the section heading | Section title shows `generalInformation` with ordinal "1" | ⚠️ NOTE — `General information` heading present; ordinal numeric prefix not visible in DOM text (see NOTE-4) |
...
| # | Test | Expected Result | Pass/Fail |
|---|------|----------------|-----------|
| 18.1 | Verify the section heading | Section title `documents` with ordinal "2" | ⚠️ NOTE — `Documents` heading present; ordinal prefix not visible in DOM text |
...
| # | Test | Expected Result | Pass/Fail |
|---|------|----------------|-----------|
| 22.1 | Verify the section heading | Section title with ordinal "5" | ⚠️ NOTE — `Activity History` heading present; ordinal prefix not visible |
...
| # | Test | Expected Result | Pass/Fail |
|---|------|----------------|-----------|
| 24.1 | Verify the section ordinal | Section renders with ordinal **2** (collides with Documents) | ⚠️ NOTE — `Equipment Notes` heading present with same ordinal semantics; ordinal numeric value not rendered as visible number |
