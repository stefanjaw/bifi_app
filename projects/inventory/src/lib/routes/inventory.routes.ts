...
export const INVENTORY_SETTINGS_ROUTES: Routes = [
  {
    ...
    loadComponent: () =>
      import('../features/product-types-list/product-types-list').then(c => c.ProductTypesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/product-type-form/product-type-form').then(c => c.ProductTypeForm),
...
export const INVENTORY_ROUTES: Routes = [
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/warehouses-list/warehouses-list').then(c => c.WarehousesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/warehouse-form/warehouse-form').then(c => c.WarehouseForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/warehouse-detail/warehouse-detail').then(c => c.WarehouseDetail),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/location-form/location-form').then(c => c.LocationForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/products-list/products-list').then(c => c.ProductsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/movements-list/movements-list').then(c => c.MovementsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/movement-form/movement-form').then(c => c.MovementForm),
    data: { resource: 'inventory/movements/create' },
  },
  {
    path: 'transfer',
    canActivate: [permissionGuard],
    loadComponent: () => import('../features/transfer/transfer').then(c => c.Transfer),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/uom-categories-list/uom-categories-list').then(c => c.UomCategoriesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../features/uom-category-form/uom-category-form').then(c => c.UomCategoryForm),
  ...
  },
  {
    path: 'uoms',
    canActivate: [permissionGuard],
    loadComponent: () => import('../features/uoms-list/uoms-list').then(c => c.UomsList),
    data: { resource: 'inventory/uoms/list' },
  },
  {
    path: 'uoms/new',
    canActivate: [permissionGuard],
    loadComponent: () => import('../features/uom-form/uom-form').then(c => c.UomForm),
