...
export const ACCOUNTING_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../components/accounts-list/accounts-list').then(m => m.AccountsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/account-form/account-form').then(m => m.AccountForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/journals-list/journals-list').then(m => m.JournalsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/journal-form/journal-form').then(m => m.JournalForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/journal-entries-list/journal-entries-list').then(m => m.JournalEntriesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/journal-entry-form/journal-entry-form').then(m => m.JournalEntryForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/payments-list/payments-list').then(m => m.PaymentsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/taxes-list/taxes-list').then(m => m.TaxesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/tax-form/tax-form').then(m => m.TaxForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/discounts-list/discounts-list').then(m => m.DiscountsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/discount-form/discount-form').then(m => m.DiscountForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/fiscal-positions-list/fiscal-positions-list').then(m => m.FiscalPositionsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/fiscal-position-form/fiscal-position-form').then(m => m.FiscalPositionForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/payment-terms-list/payment-terms-list').then(m => m.PaymentTermsList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/payment-term-form/payment-term-form').then(m => m.PaymentTermForm),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/invoices-list/invoices-list').then(m => m.InvoicesList),
  ...
  },
  {
    ...
    canActivate: [permissionGuard],
    loadComponent: () =>
      import('../components/invoice-form/invoice-form').then(m => m.InvoiceForm),
