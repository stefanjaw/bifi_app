...
import { isFormControlInvalid } from '@avalantec/base-app/system/modules/form/libraries/form-control-utils';
...
export class ErrorStateTracker {
   ...
   */
  constructor(
    props: Pick<ErrorStateTracker, 'ngControl' | 'injector' | 'updateCallback'>,
  ) {
    Object.assign(this, props);

    if (!this.ngControl || !this.ngControl.control) {
      throw new Error(
        'ErrorStateTracker must be used with a valid form control.',
      );
    }
