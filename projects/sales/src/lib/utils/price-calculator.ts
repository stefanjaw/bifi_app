...
export function calculateTotals(lineItems: LineItemInput[], selectedTaxes: TaxOption[]): TotalsPreview {
 ...
 * @param lineTaxIds Parallel array of tax ID arrays — lineTaxIds[i] is the taxIds for lineItems[i]
 * @param allTaxes Full list of available tax options (used to resolve percentage and name)
 */
