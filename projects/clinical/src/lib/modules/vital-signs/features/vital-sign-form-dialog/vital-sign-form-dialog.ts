...
import { VitalSignForm } from '../../services/vital-sign-form';
import { vitalSign } from '../../interfaces/vital-signs';

@Component({
  selector: 'bifi-app-vital-sign-form-dialog',
  imports: [
    ReactiveFormsModule,
    DialogModule,
    InputText,
  ...
  templateUrl: './vital-sign-form-dialog.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VitalSignFormDialog extends BaseDialog {
  private crud = inject(CrudVitalSigns);
  protected formService = inject(VitalSignForm);
  private destroy$ = inject(DestroyRef);

  form = this.formService.form;
  editEntity = signal<vitalSign | null>(null);
  submitLoading = signal(false);
  isUpdate = signal(false);
  saved = output<void>();

  open(entity?: vitalSign): void {
