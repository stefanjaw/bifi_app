...
import { ProgressNoteForm } from '../../services/progress-note-form';
import { progressNote } from '../../interfaces/progress-notes';

@Component({
  selector: 'bifi-app-progress-note-form-dialog',
  imports: [
    ReactiveFormsModule,
    DialogModule,
    InputText,
  ...
  templateUrl: './progress-note-form-dialog.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProgressNoteFormDialog extends BaseDialog {
  private crud = inject(CrudProgressNotes);
  protected formService = inject(ProgressNoteForm);
  private destroy$ = inject(DestroyRef);

  form = this.formService.form;
  editEntity = signal<progressNote | null>(null);
  submitLoading = signal(false);
  isUpdate = signal(false);
  saved = output<void>();

  open(entity?: progressNote): void {
