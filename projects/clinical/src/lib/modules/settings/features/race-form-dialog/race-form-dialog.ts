...
import { RaceForm } from '../../services/race-form';
import { race } from '../../interfaces/settings';

@Component({
  selector: 'bifi-app-race-form-dialog',
  imports: [
    ReactiveFormsModule,
    DialogModule,
    InputText,
  ...
  templateUrl: './race-form-dialog.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
/** Dialog for creating or editing a race */
export class RaceFormDialog extends BaseDialog {
  private crud = inject(CrudRaces);
  protected formService = inject(RaceForm);
  private destroy$ = inject(DestroyRef);

  form = this.formService.form;
  editEntity = signal<race | null>(null);
  submitLoading = signal(false);
  isUpdate = signal(false);
  saved = output<void>();

  open(entity?: race): void {
