...
import { CrudCondicionVenta, condicionVenta } from '../../services/crud-condicion-venta';

const columns: tableColumn<condicionVenta>[] = [
...
const filters: filter<condicionVenta>[] = [
...
@Component({
  ...
  template: `
    <h1 class="text-2xl font-bold mb-4">Condición de Venta</h1>
    <div class="flex gap-2 mb-4">
      <p-button
        ...
        icon="pi pi-plus"
        [routerLink]="['../create']"
        *bifiAppHasPermission="'cr-einvoice/condicion-venta/create:view'"
      ></p-button>
    </div>
    ...
    <bifi-app-table-layout
      ...
      [data]="data"
      [onClickRow]="gotoEdit"
      clickRowPermission="cr-einvoice/condicion-venta/update:view"
    >
      <ng-template #actions let-row>
        <bifi-app-buttons-actions
          (deleteClicked)="delete(row._id)"
          resource="cr-einvoice/condicion-venta"
        ></bifi-app-buttons-actions>
      </ng-template>
    </bifi-app-table-layout>
  `,
...
export class CondicionVentaList {
  private resourceManager = inject<ResourceManager<condicionVenta>>(ResourceManager);
  ...
  gotoEdit = (element: condicionVenta) => {
